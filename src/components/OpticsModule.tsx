        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:gap-16">
          <AnimatedSection>
            ...
            <div className="mt-8 grid gap-3 sm:mt-10 sm:grid-cols-2">
              <div className="rounded-cards bg-kelp p-5 sm:p-7">
                <p className="u-label-sm text-mist/80">Очки на заказ</p>
                <p className="kinetic mt-4 text-[2.2rem] text-phosphor sm:mt-6 sm:text-[2.6rem]">
                  от 3 500 ₽
                </p>
              </div>
              <div className="rounded-cards bg-kelp/40 p-5 sm:p-7">
          ...
          <AnimatedSection delay={0.1}>
            <div className="rounded-cards bg-white/[0.02] p-5 sm:p-9">
              ...
              <motion.div
                ...
                className="mt-5 flex flex-col sm:mt-6"
              >
                {opticsCatalogue.map((item) => (
                  <motion.button
                    ...
                    className="group flex flex-col gap-1.5 border-t border-white/[0.06] py-3.5 text-left transition-colors duration-300 first:border-t-0 first:pt-0 hover:bg-white/[0.02] sm:flex-row sm:items-center sm:justify-between sm:gap-6 sm:py-4"
                  >
                    <span className="min-w-0 text-[14px] leading-snug text-silver transition-colors group-hover:text-mist">
                      {item.name}
                    </span>
