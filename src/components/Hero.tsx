...
export function Hero() {
  ...
  return (
    <section
      id="home"
      ref={ref}
      className="relative flex min-h-[100svh] flex-col items-center overflow-hidden pt-[calc(5.5rem+env(safe-area-inset-top))] sm:pt-[136px]"
    >
      {/* atmosphere */}
      ...
      >
        <div className="mx-auto grid max-w-[1440px] divide-y divide-white/10 px-5 py-5 sm:grid-cols-3 sm:gap-8 sm:divide-y-0 sm:px-6 sm:py-6 lg:px-10">
          {heroStrip.map((item) => (
            <div key={item.label} className="flex flex-col gap-1 py-3 first:pt-0 last:pb-0 sm:py-0">
